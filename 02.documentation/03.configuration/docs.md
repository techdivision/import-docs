...
The necessary configuration has to be defined in a simple JSON file. An example that imports the Magento 2 sample data in a Magento 2 CE version 2.1.2 can be found in our [examples](projects/sample-data/ce/212/conf/techdivision-import.json).
